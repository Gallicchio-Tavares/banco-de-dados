...
-- o asterico pega todas as colunas da tabela, se vc quiser algo especifico tem q por os nomes.
...
update itens_consumo set preco_unit 

ALTER TABLE itens_consumo DROP COLUMN info_nutri;
